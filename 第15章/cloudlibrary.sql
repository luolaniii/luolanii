...
CREATE TABLE `problem`  (
        `problem_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
        `problem_uid` int(11) NOT NULL  COMMENT '反馈人id',
        `problem_title` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
        `problem_page` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面',
        `problem_content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内容）',
        `problem_link` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系方式',
        `problem_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '0:未解决,1:已解决）',
        `problem_time` datetime  NULL DEFAULT NULL COMMENT '反馈时间',
        PRIMARY KEY (`problem_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

INSERT INTO `problem`
(`problem_id`, `problem_uid`, `problem_title`, `problem_page`, `problem_content`, `problem_link`, `problem_status`, `problem_time`)
VALUES
    (1, 2, '更新书籍', '图书借阅', '换大号v打开落水洞v看', '20200405', '0', NOW());
# luo